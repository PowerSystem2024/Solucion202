...
const educacion = ref([
  {fecha: '2023', title: 'Desarrollo de Microservicios con Node.js y Kubernetes', descripcion: 'Profundización en la creación y despliegue de microservicios utilizando Node.js y orquestación con Kubernetes.', enlace:'http:www.direccion.com'},
  {fecha: '2022', title: 'Bases de Datos NoSQL Avanzadas (MongoDB)', descripcion: 'Estudio en profundidad de MongoDB, incluyendo diseño de esquemas, indexación, agregaciones y replicados.', enlace:'http:www.direccion.com'},
  {fecha: '2021', title: 'Arquitectura de Software en la Nube', descripcion: 'Análisis de las diferentes arquitecturas en la nube (IaaS, PaaS, SaaS), con énfasis en la implementación de aplicaciones escalables y resilientes.', enlace:'http:www.direccion.com'},
  {fecha: '2019', title: 'Programación Orientada a Objetos Avanzada con Java', descripcion: 'Ampliación de conocimientos en POO, diseño de patrones y desarrollo de aplicaciones empresariales con Java EE.', enlace:'http:www.direccion.com'},
  {fecha: '2018', title: 'Introducción a Python para Ciencia de Datos', descripcion: 'Primeros pasos en Python, con foco en análisis de datos, manipulación de datos con Pandas y visualización con Matplotlib.', enlace:'http:www.direccion.com'}
]);
</script>
...
<template>
    <ul>
        ...
        <a class="enlace" :href="item.enlace" target="_blank">Ver proyecto</a>
    </li>
    </ul>
</template>
...
body {
  ...
  --bgColor: rgb(170, 133, 133); /* Variable para el color de fondo */
...
ul li .fecha {
  ...
  font-weight: 1000; /* Hace el texto en negrita */
  display: grid; /* Usa un layout de cuadrícula */
