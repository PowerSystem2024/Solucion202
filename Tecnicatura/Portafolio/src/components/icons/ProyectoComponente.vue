...
.galeria{
    /*Establece el ancho de la galeria al 100% del contenedor padre*/
    width: 100%;
    /*Establece la altura de la galeria al 100% del contenedor padre*/
    height: 100%;
    /*Utiliza flexbox para organizar los elementos hijos en la galeria*/
    display: flex;
    /*Permite que los elementos se ajusten y pasen a la siguiente linea si no caben en una sola fila*/
    flex-wrap: wrap;
...
/*Vamos a definir una animación llamada 'gradient' para cambiar la posición del fondo*/
@keyframes gradient {
